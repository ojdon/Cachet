                    ...
                    <div class="stats-widget">
                        ...
                        <div class='stats-body'>
                            <div class="list-group">
                                ...
                                <a class="list-group-item" href="{{ $entry->link }}" target="_blank">{{ $entry->title }}, <small>{{ $entry->pubDate }}</small> <span class="badge badge-pill badge-secondary"><i class="ion-android-open"></i></span></a>
                                @endforeach
                            </div>
                        </div>
                    </div>
