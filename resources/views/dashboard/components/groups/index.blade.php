...
<div class="content-panel">
    ...
    <div class="content-wrapper">
        <div class="header sub-header">
            ...
            <a class="btn btn-md btn-success float-right" href="{{ cachet_route('dashboard.components.groups.create') }}">
                ...
                <div class="row striped-list-item" data-orderable-id="{{ $group->id }}">
                    <div class="col-6">
                        <h4>
                            ...
                            @endif
                            {{ $group->name }}
                            <span class="badge badge-info float-none">{{ $group->components->count() }}</span>
                        </h4>
                    </div>
